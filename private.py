    ...
    await message.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        "SUPPORT CHAT ♥️", url=f"https://t.me/{SUPPORT_GROUP}"
                    )
                ]
            ]
        ),
...
async def ghelp(_, message: Message):
    await message.reply_text(
        f"""**HEY THERE! I  PLAY MUSIC IN THE VOICE 👀 CHATS OF TELEGRAM GROUPS.**""",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        "🟡 CLICK ME FOR HELP 🟡", url=f"https://t.me/{BOT_USERNAME}?start"
                    )
                ]
            ]
        ),
